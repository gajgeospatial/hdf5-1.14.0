...
$srcdir  = 'N:/Development/Dev_Base/hdf5-1.14.0/test'
$utils_testdir=N:/Development/Dev_Base/hdf5-1.14.0/msvc_temp/bin/
$testdir=N:/Development/Dev_Base/hdf5-1.14.0/msvc_temp/test/H5TEST
