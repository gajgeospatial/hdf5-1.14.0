...
set_target_properties(h5diff-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5diff-shared.exe"
  )
...
set_target_properties(h5ls-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5ls-shared.exe"
  )
...
set_target_properties(h5debug-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5debug-shared.exe"
  )
...
set_target_properties(h5repart-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5repart-shared.exe"
  )
...
set_target_properties(h5mkgrp-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5mkgrp-shared.exe"
  )
...
set_target_properties(h5clear-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5clear-shared.exe"
  )
...
set_target_properties(h5delete-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5delete-shared.exe"
  )
...
set_target_properties(h5import-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5import-shared.exe"
  )
...
set_target_properties(h5repack-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5repack-shared.exe"
  )
...
set_target_properties(h5jam-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5jam-shared.exe"
  )
...
set_target_properties(h5unjam-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5unjam-shared.exe"
  )
...
set_target_properties(h5copy-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5copy-shared.exe"
  )
...
set_target_properties(h5stat-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5stat-shared.exe"
  )
...
set_target_properties(h5dump-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5dump-shared.exe"
  )
...
set_target_properties(h5format_convert-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5format_convert-shared.exe"
  )
...
# Import target "h5watch-shared" for configuration "MinSizeRel"
set_property(TARGET h5watch-shared APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(h5watch-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/h5watch-shared.exe"
  )
